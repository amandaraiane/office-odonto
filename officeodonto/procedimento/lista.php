...
$sql = "select * from procedimento where nome like '%$filtro%' order by nome";
$consulta = mysqli_query($conexao, $sql);
$registros = mysqli_num_rows($consulta);
?>
<div class="container">
    <h5>Olá, <?php echo $_SESSION["usuario"]["nome"]; ?></h5>
    <h1 class="">Listar Procedimentos</h1>
    <hr>
    ...
    <table class="mt-2 border  table table-striped">
        ...
        <tbody>
            <?php while ($procedimento = mysqli_fetch_assoc($consulta)) { ?>
                <tr>
                    <th><?php echo $procedimento['id']; ?></th>
                    <td><?php echo $procedimento['nome']; ?></td>
                    <td><?php echo $procedimento['id_dentista']; ?></td>
                    <td>
                        <a href="./editar.php?id=<?php echo $procedimento['id']; ?>" class="btn btn-primary">EDITAR</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
