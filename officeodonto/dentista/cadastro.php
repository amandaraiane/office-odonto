...
<div class="container">
    <div class="row">
        ...
        <h5>Olá, <?php echo $_SESSION["usuario"]["nome"]; ?></h5>
            <h1 class="">Cadastro de Dentista</h1>
        </div>
        <div class="col-md-8 text-right">
            <a class="btn btn-primary" href="lista.php">CONSULTAR DENTISTAS</a>
        </div>
    </div>
    <form method="post" action="processa_cadastrar.php" autocomplete="off">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <input type="text" name="especializacao" class="form-control" maxlength="40" required /><br>
            </div>
